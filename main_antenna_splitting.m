...
for Count_P=1:length(P_D1)
    ...
    for Count_I=1:Iterations
       ...
       %% Nếu không chia ngẫu nhiên, bỏ dòng trên và mở các dòng sau
        %H_I=H;
        %H_I(1:M_h,:)=[];
        %H_I(:,1:N_h)=[];
        %H_h=H(1:M_h,1:N_h);
        ...
        Rician=1;
        H_1 = raylrnd(1 ,M_I, M_h); 
        H_2 = raylrnd(1, N_h, N_I); 
        ...
        %% Công suất truyền tại thiết bị # 2
        if Count_I==1
